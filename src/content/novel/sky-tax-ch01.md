...
chapter: 1
order: 1
description: "《天空税》第1章 · 铜级人生 —— 2057年，星链垄断通信与算力，按token计费征税。"
...
铜级。铜是良导体，但在星链的等级体系里，它是垫底的那一层。往上还有银、金、铂金，以及不对外公开的企业定制级。每一级的流量配额和算力配额相差一个数量级，价格却不是线性增长——铂金级用户的月费足够一个铜级家庭活接近四年，换来的不是一千倍，是「不限量」三个字。

水烧开了。陆远把热水倒进暖壶，给自己泡了杯廉价的花茶——这是女儿出生后他戒掉咖啡的第三个年头。他靠在灶台边喝了一口，热气模糊了手机屏幕上的通知栏。

星链账户管理中心推送了一条友情提醒，措辞亲切：「亲爱的陆远先生，您本月的配额使用进度已达92%。距离结算周期还有七天。升级至白银套餐仅需每月499信用点，可享受10倍流量与5倍算力，助您畅享无缝连接体验。」
...
OrbitNet AI高级分析：预估算力需求 5,000 万 token。

下方用灰色小字标注：*当前账户等级（铜级）预估传输时间：按每日配额累积需十六年。预估分析队列等待时间：无法计算。*
...
**「尊敬的陆远先生，升级至白银套餐仅需每月499信用点。当前特惠：首月五折。」**
