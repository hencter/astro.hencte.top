...
chapter: 8
order: 8
description: "《天空税》第8章 · 不归点 —— 2057年，星链垄断通信与算力，按token计费征税。"
...
*一、对抗目标性质*
- 星链通讯有限责任公司（以下简称"星链"）当前的业务覆盖全球187个签约国，运营近地轨道卫星124,110颗（截至2057年6月），直接或间接控制全球约93%的洲际通信流量、78%的算力基础设施租赁市场，以及100%的近地轨道非军事通信频段授权。
...
她是欧盟数字自由委员会任命的星链事务特使，一个表面上的身份——官方角色是代表欧盟与星链进行服务协议谈判，监督其在欧洲市场的合规运营。但真正让她在这个位置上待了四年的，是她同时在数据党和星链高层之间保持的那条窄如刀刃的关系。她向数据党传递星链的动向——不是全部，是经过筛选的一部分。她向星链传递数据党在做什么——同样不是全部，是筛选过的。而她四年不肯从这根钢丝上下来的原因装在一个没有人知道的地方：她哥哥在里斯本的私立医院里，靠星链合作医疗体系的铂金级透析配额活着。那份配额的授权编号，每年都要布鲁塞尔签字续期一次。
...
而那"一小部分"不是自然发生的。三小时前，法尔汉向这颗卫星的地面段推送了一份格式完全合法的激光器校准参数表——星链的运维规程里，这种表每月下发两次，任何一台合规终端都能生成。唯一的区别是，这份表的解析分支里，多了一个米兰三年前留下的选项。
