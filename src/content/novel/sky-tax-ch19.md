...
chapter: 19
order: 19
description: "《天空税》第19章 · 四十七小时 —— 2057年，星链垄断通信与算力，按token计费征税。"
...
十一小时。三十六小时的准备和二十二小时的运送可以并行——真正的瓶颈是准备本身。女儿的医疗授权还剩四十七小时。余量只有这十一小时。
...
塞拉斯不知道米兰和陆远之间那通电话的内容。他不知道米兰的女儿在数据党的据点里。他也不知道一件制度上的小事：A1授权令在三级安全事件下会自动进入签署队列，制度给首席协议架构师一个小时的否决窗口，超时视为默许——凌晨四点零七分，推送抵达；四点零八分，米兰做了他过去几个月每一次都会做的那个动作之外的一个动作：他把手从键盘上拿开了。签发记录上于是自动盖上了他的名字。签署人和否决者，在这套制度里是同一种身份——区别只在于手放没放在键盘上。
